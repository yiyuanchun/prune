...
from core.configuration.consts import EPSILON, VERBOSE
from core.utils.verification_properties_utils import (
    get_test_property_input_2_output_1,
    get_test_property_input_3_output_1,
)
...
def _legacy_acas_output_ordering_check():
    return
    """
