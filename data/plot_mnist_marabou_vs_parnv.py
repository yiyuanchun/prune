...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Plot Marabou elapsed_seconds against split-MNIST elapsed_seconds "
    ...
    parser.add_argument(
        "--marabou-csv",
        type=Path,
        default=src_dir / "MNIST" / "mnist_robustness_marabou_results_0_50_5.csv",
        help="CSV containing sample_index and elapsed_seconds for Marabou.",
    )
    parser.add_argument(
        "--split-csv",
        type=Path,
        default=src_dir / "MNIST" / "split_mnist_verification_results_0_52_5.csv",
        help="CSV containing sample_index and elapsed_seconds.",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=src_dir / "MNIST" / "mnist_marabou_vs_parnv_5_scatter.png",
